  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <div className={styles.section}>
        <h2>Introduction</h2>
        <p>
          SkateHouseMedia (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;)
          operates the website skatehousemedia.com (the &quot;Site&quot;). This
      ...
      <div className={styles.section}>
        ...
        <ul>
          <li>
            ...
            analyze website traffic. Google Analytics uses cookies to collect
            anonymous usage data. For more information, visit{" "}
            <a
          ...
          <li>
            ...
            advertisements. AdSense may use cookies and web beacons to serve ads
          ...
          <li>
            <strong>Embedded Content:</strong> Some pages embed videos from
            YouTube and Vimeo. These services may collect data about you when
            you interact with the embedded content. Please refer to their
      ...
      <div className={styles.section}>
        ...
        <p>
          ...
          outlined in this policy. Analytics data is retained according to the
          default retention settings of our third-party analytics providers.
        </p>
      </div>
...
export default function PrivacyIsland({ pathname }: { pathname?: string }) {
  return (
