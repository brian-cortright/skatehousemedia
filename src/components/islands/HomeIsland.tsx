...
import styles from "./HomeIsland.module.css";
...
function HomeContent() {
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <Headline className={styles.postFeedTitle} as="h2" variant="6">
        Posts
      </Headline>
      ...
      {hasMore && !hasActiveFilters && (
        <div
          style={{
            ...
            margin: "var(--spacing-medium_300) 0",
          }}
        >
...
export default function HomeIsland({ pathname }: { pathname?: string }) {
  return (
