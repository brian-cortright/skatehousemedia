...
import styles from "./ShuffleIsland.module.css";
import {
  BodyText,
  Headline,
  Subhead,
...
import { getVimeoId, getYouTubeId } from "@/utils/videoUtils";
      ...
      openPopup({
        children: (
          <div className={styles.messageWrapper}>
            <Subhead variant="2">Still watching?</Subhead>
            <BodyText variant="4">
  ...
  return (
    <main className={styles.pageWrapper}>
      ...
      <BodyText
        ...
        variant="5"
      >
        Endless video content injected straight into your veins. Sit back and
        enjoy the session.
      </BodyText>
        ...
        <div className={styles.playerCard}>
          {youtubeId ? (
            ...
            <video
              ...
              muted
              preload="none"
              poster={(currentPost?.thumbnail as any)?.url ?? undefined}
              ref={videoRef}
          ...
          {upNext.map((post, i) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${(post.thumbnail as any)?.url})`,
                }}
              />
...
export default function ShuffleIsland({ pathname }: { pathname?: string }) {
  return (
